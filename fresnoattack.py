...
class FresnoAttack(tk.Frame):
    def __init__(self, parent, controller):
        ...
        #Creating the title for the Fresno Attack drill
        title = StyledLabel(
            main_frame,
            text = "Fresno Attack Drill",
            size = 21,
            bold = True
        )
        ...
        subtitle = StyledLabel(
            main_frame,
            text = "Drill Focused finishing with momentum over the defender!",
            size = 14,
            bold = False
        )
        ...
        #Load the image
        drillImage = Image.open("assets/fresno_attack.png")
        ...
        steps = [
            "1. Blue player starts with the ball and drives towards the cones",
            "2. Red player waits for the blue player to cross through the cones to play defense",
            "3. Blue player has 8 seconds to get to the rim and score",
            "4. Repeat 25 times on each side and get a score out of 50"
        ]

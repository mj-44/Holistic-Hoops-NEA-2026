...
class BackPedalFinishingPF(tk.Frame):
    def __init__(self, parent, controller):
        ...
        #Creating the title for the Back Pedal Finishing drill page
        title = StyledLabel(
            main_frame,
            text = "Back Pedal Finishing Drill",
            size = 21,
            bold = True
        )
        title.pack(pady=(0,20))

        #Subtitle for the drill page
        subtitle = StyledLabel(
            main_frame,
            text = "Finishing despite momentum shifts with footwork",
            size = 16,
            bold = False
        )
        ...
        drillImage = Image.open("assets/back_pedal_finishing_pf.png")
        ...
        steps = [
            ...
            "3. Between the legs and drive to the rim",
            "4. Pumpfake near the basket to simulate contact and finish near the rim",
            "5. Get a score out of 50 (25 finishes from each side)",
        ]

...
class OffBalancePullUps(tk.Frame):
    #Off-Balance Pull-Ups Drill page class
    ...
    def __init__(self, parent, controller):
        ...
        #Creating the title for the Off-Balance Pull-Ups Drill page
        title = StyledLabel(
            main_frame,
            text = "Off-Balance Pull-Ups Drill",
            size = 21,
            bold = True
        ...
        subtitle = StyledLabel(
            main_frame,
            text = "Drill Focused on Improving Shooting From an Off-Balanced Position",
            size = 14,
            bold = False
        )
        ...
        #Load the image
        drillImage = Image.open("assets/off_balance_pullups.png")
        ...
        steps = [
            "1. Start from an unbalanced lean position",
            "2. Pull the ball back and step back to regain balance",
            "3. Perform any dribble move (less than 3 dribbles) and shoot",
            "4. Record a score out of 50 (25 on each side)",
        ]

        for step in steps:
            step_label = StyledLabel(
                main_frame,
                text = step,
                size = 14,
                bold = False

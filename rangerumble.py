...
class RangeRumble(tk.Frame):
    def __init__(self, parent, controller):
        ...
        #Creating the title for the range rumble drill
        title = StyledLabel(
            main_frame,
            text = "Range Rumble Drill",
            size = 21,
            bold = True
        )
        ...
        subtitle = StyledLabel(
            main_frame,
            text = "Drill Focused on Improving Range!",
            size = 14,
            bold = False
        )
        ...
        #Load the image
        drillImage = Image.open("assets/range_rumble.png")
        ...
        steps = [
            "1. Start from either the green or red spot",
            "2. Do an in and out toward the other cross",
            "3. Sidestep off this dribble and shoot a deep 3",

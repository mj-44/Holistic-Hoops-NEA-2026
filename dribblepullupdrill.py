...
class DribblePullUpDrill(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        #Creating the title for the Dribble Pull-Up Drill page
        title = StyledLabel(
            main_frame,
            text = "Dribble Pull-Up Drill",
            size = 21,
            bold = True
        ...
        subtitle = StyledLabel(
            main_frame,
            text = "Drill Focused on Improving Mid-Range Shooting Off the Dribble",
            size = 14,
            bold = False
        )
        ...
        #Load the image
        drillImage = Image.open("assets/dribble_pullup_drill.png")
        ...
        steps = [
            "1. Start from the 3 point line on either wing.",
            "2. Dribble towards the basket using a controlled dribble from stationary or off of a jabstep.",
            "3. Pull up for a mid-range jump shot as you reach your shooting spot.",
            "4. Record whether the shot was a make or a miss.",
            "5. Repeat 25 times from each wing and score out of 50."
        ]

...
class DrivingLayDrill(tk.Frame):
    #Driving Lay Drill page class
    ...
    def __init__(self, parent, controller):
        ...
        subtitle = StyledLabel(
            main_frame,
            text = "Drill Focused on different dribble moves to get to the basket",
            size = 14,
            bold = False
        )
        ...
        #Load the image
        drillImage = Image.open("assets/driving_layup_drill.png")
        ...
        steps = [
            ...
            "2. Dribble towards the free throw line.",
            "3. Perform a spin move or behind the back towards the basket.",
            "4. Drive to the rim and finish with a layup or dunk.",
